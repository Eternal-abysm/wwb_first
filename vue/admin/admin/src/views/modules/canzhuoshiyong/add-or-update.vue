<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/18da3753d22a4199b5abc44dee037d48.png) fixed"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="餐桌号码" prop="canzhuohaoma">
					<el-input v-model="ruleForm.canzhuohaoma" placeholder="餐桌号码" clearable  :readonly="ro.canzhuohaoma"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="餐桌号码" prop="canzhuohaoma">
					<el-input v-model="ruleForm.canzhuohaoma" placeholder="餐桌号码" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="餐桌位置" prop="canzhuoweizhi">
					<el-input v-model="ruleForm.canzhuoweizhi" placeholder="餐桌位置" clearable  :readonly="ro.canzhuoweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="餐桌位置" prop="canzhuoweizhi">
					<el-input v-model="ruleForm.canzhuoweizhi" placeholder="餐桌位置" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="可坐人数" prop="kezuorenshu">
					<el-input v-model="ruleForm.kezuorenshu" placeholder="可坐人数" clearable  :readonly="ro.kezuorenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="可坐人数" prop="kezuorenshu">
					<el-input v-model="ruleForm.kezuorenshu" placeholder="可坐人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="使用时间" prop="shiyongshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shiyongshijian" label="使用时间" prop="shiyongshijian">
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='canzhuohaoma'){
							this.ruleForm.canzhuohaoma = obj[o];
							this.ro.canzhuohaoma = true;
							continue;
						}
						if(o=='canzhuoweizhi'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `canzhuoshiyong/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.canzhuoshiyongCrossAddOrUpdateFlag = false;
						 this.parent.search();
