		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"padding":"20px 0px 0","margin":"0 0 0px","borderColor":"#ececde","borderStyle":"solid","background":"#fff","borderWidth":"1px 1px 0 "}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"padding":"16px 12px 10px","margin":"0 0 0px","borderColor":"#e2f0e2","flexWrap":"wrap","background":"#fff","borderWidth":"0px","display":"flex","width":"auto","borderStyle":"solid","justifyContent":"center","zIndex":"999"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","minWidth":"90px","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"1px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}' v-if="isAuth('orders'+'/'+orderStatus,'新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 16px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","minWidth":"90px","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"1px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}' v-if="isAuth('orders'+'/'+orderStatus,'删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>


					<download-excel v-if="isAuth('orders'+'/'+orderStatus,'导出')" class="export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "订单.xls">
						<!-- 导出excel -->
						<el-button :style='{"border":"0","cursor":"pointer","padding":"0 16px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"2px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}' type="danger">导出</el-button>
					</download-excel>


					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 16px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"2px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}' v-if="isAuth('orders'+'/'+orderStatus,'日销量')" type="warning" @click="dayNumberChartDialog()">日销量</el-button>

					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 16px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"2px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}' v-if="isAuth('orders'+'/'+orderStatus,'月销量')" type="warning" @click="monthNumberChartDialog()">月销量</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 16px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"2px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}' v-if="isAuth('orders'+'/'+orderStatus,'年销量')" type="warning" @click="yearNumberChartDialog()">年销量</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 16px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"2px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}'	v-if="isAuth('orders'+'/'+orderStatus,'品销量')"	type="warning"	@click="goodnameNumberChartDialog()">商品销量</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 16px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"2px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}' v-if="isAuth('orders'+'/'+orderStatus,'类销量')" type="warning" @click="goodtypeNumberChartDialog()">类型销量</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 16px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"2px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}' v-if="isAuth('orders'+'/'+orderStatus,'日销额')" type="warning" @click="dayAmountChartDialog()">日销额</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 16px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"2px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}' v-if="isAuth('orders'+'/'+orderStatus,'月销额')" type="warning" @click="monthAmountChartDialog()">月销额</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 16px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"2px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}' v-if="isAuth('orders'+'/'+orderStatus,'年销额')" type="warning" @click="yearAmountChartDialog()">年销额</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 16px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"2px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}' v-if="isAuth('orders'+'/'+orderStatus,'品销额')" type="warning" @click="goodnameAmountChartDialog()">商品销额</el-button>
            
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 16px","boxShadow":"inset 0px -3px 2px #ececde","margin":"0 10px 6px 0","borderColor":"#ececde","color":"#333","outline":"none","borderRadius":"20px","background":"#fff","borderWidth":"2px","width":"auto","fontSize":"16px","borderStyle":"solid","height":"44px"}' v-if="isAuth('orders'+'/'+orderStatus,'类销额')" type="warning" @click="goodtypeAmountChartDialog()">类型销额</el-button>
				</el-row>
			</el-form>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"1px solid #85bfeb","cursor":"pointer","padding":"0 10px 0 26px","margin":"0 5px 6px","outline":"none","color":"#1e98f5","borderRadius":"20px","background":"url(http://codegen.caihongy.cn/20230329/38553f099fa74a2d86e2206c373a9539.png) no-repeat 5px center / 20px","width":"auto","fontSize":"15px","height":"32px"}' v-if=" isAuth('orders'+'/'+orderStatus,'查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"1px solid #a4dbdd","cursor":"pointer","padding":"0 10px 0 26px","margin":"0 5px 6px","outline":"none","color":"#15a4aa","borderRadius":"20px","background":"url(http://codegen.caihongy.cn/20230329/99f867042acb4c4aae637c8bfcf6714a.png) no-repeat 3px center","width":"auto","fontSize":"15px","height":"32px"}' v-if=" isAuth('orders'+'/'+orderStatus,'修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>

							<el-button :style='{"border":"1px solid #a4dbdd","cursor":"pointer","padding":"0 10px 0 26px","margin":"0 5px 6px","outline":"none","color":"#15a4aa","borderRadius":"20px","background":"url(http://codegen.caihongy.cn/20230329/99f867042acb4c4aae637c8bfcf6714a.png) no-repeat 3px center","width":"auto","fontSize":"15px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'核销')" type="primary" size="mini" @click="writeOff(scope.row)">核销</el-button>




							<el-button :style='{"border":"1px solid #e68080","cursor":"pointer","padding":"0 10px 0 26px","margin":"0 5px 6px","outline":"none","color":"#c00","borderRadius":"20px","background":"url(http://codegen.caihongy.cn/20230329/c5ea125f385740a3a3b9aed07f5dfe2c.png) no-repeat 5px center / 20px","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('orders'+'/'+orderStatus,'删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
