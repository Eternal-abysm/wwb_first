...
import canzhuoshiyongList from '../pages/canzhuoshiyong/list'
import canzhuoshiyongDetail from '../pages/canzhuoshiyong/detail'
import canzhuoshiyongAdd from '../pages/canzhuoshiyong/add'
      ...
      redirect: '/index/home'
    },
		{
			...
			children:[
				...
				{
					path: 'canzhuoshiyong',
					component: canzhuoshiyongList
				},
				{
					path: 'canzhuoshiyongDetail',
					component: canzhuoshiyongDetail
				},
				{
					path: 'canzhuoshiyongAdd',
					component: canzhuoshiyongAdd
				},
				{
					path: 'caipinleixing',
